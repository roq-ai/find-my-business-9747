...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Meeting Request.create': {
    roles: ['company-owner', 'meeting-approver'],
    key: 'meeting_request',
    tenantPath: [],
    userPath: [],
  },
  'System Update.update': {
    roles: ['company-owner', 'company-employee'],
    key: 'system_update',
    tenantPath: [],
    userPath: [],
  },
  'Meeting Approval.update': {
    roles: ['company-owner', 'company-employee'],
    key: 'meeting_approval',
    tenantPath: [],
    userPath: [],
  },
};

const ownerRoles: string[] = ['company-owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['company-owner', 'company-employee', 'meeting-approver', 'system-administrator'];
