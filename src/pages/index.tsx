...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Find my business (FMB)`}</title>

        <meta
          name="description"
          content="With Find My Business (FMB), connect and collaborate with businesses, schedule meetings, and make decisions with ease. It's not just a platform, it's your business partner."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606836591695-4d58a73eba1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMG1lZXRpbmd8ZW58MHx8fHwxNjk1NDcwODQxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@getrodeo?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Rodeo Project Management Software`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Find my business (FMB)`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Find My Business (FMB), connect and collaborate with businesses, schedule meetings, and make decisions with ease. It's not just a platform, it's your business partner.`}
            </Text>
            <Box
